""" This code runs the twice daily update to sync our database with Cricketstatz"""
...
from app.config import DATABASE_URL, CRICKETSTATZ_CLUB_ID, CRICKETSTATZ_API_URL, BATTING_STATS_REPORT_MODE, \
    BOWLING_STATS_REPORT_MODE, CATCHING_STATS_REPORT_MODE, RUNOUT_STATS_REPORT_MODE
